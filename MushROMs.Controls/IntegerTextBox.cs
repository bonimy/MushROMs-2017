...
namespace MushROMs.Controls
{
    ...
    public class IntegerTextBox : TextBox, IIntegerComponent
    {
        ...
        private NumberStyles NumberStyle => (AllowHex ? NumberStyles.AllowHexSpecifier : NumberStyles.None) |
        ...
        {
            // Parse new value.
            if (Int32.TryParse(Text, NumberStyle, CultureInfo.InvariantCulture, out int textValue))
            {
