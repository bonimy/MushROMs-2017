...
namespace MushROMs.Controls
{
    public static class WinAPIMethods
    {
        ...
        public static int PaddedBorderWidth => GetSystemMetrics(SM_CXPADDEDBORDER); public static Size PaddedBorderSize => new Size(PaddedBorderWidth, PaddedBorderWidth);
        ...
        public static void SetBorderStyle(IWin32Window window, BorderStyle value)
        {
            ...
            var exstyle = UnsafeNativeMethods.GetWindowLong(window, GWL_EXSTYLE) & ~WS_EX_CLIENTEDGE;
        ...
        public static Rectangle GetWindowRectangle(IWin32Window window)
        {
            ...
            return UnsafeNativeMethods.GetWindowRect(window);
        }
