...
namespace MushROMs.NES.SMB1
{
    public struct MetaObject
    {
        ...
        public int Page => X >> 4; public int X
        {
            get;
            private set;
        }
        ...
        public int Left => Width >= 0 ? X : X - Width; public int Right => Width >= 0 ? X + Width : X; public int Top => Height >= 0 ? Y : Y - Height; public int Bottom => Height >= 0 ? Y + Height : Y; public ObjectType ObjectType
        {
            get;
            private set;
        }
