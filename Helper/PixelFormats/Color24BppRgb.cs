...
namespace Helper.PixelFormats
{
    ...
    public unsafe struct Color24BppRgb
    {
        ...
        public int Value
        {
            get => (Red << (BitArray.BitsPerByte * RedIndex)) |
                    (Green << (BitArray.BitsPerByte * GreenIndex)) |
                    (Blue << (BitArray.BitsPerByte * BlueIndex));
            set => this = new Color24BppRgb(value);
        }

        /// <summary>
        /// Gets or sets the <see cref="System.Drawing.Color"/> that represents
        /// this <see cref="Color24BppRgb"/>.
        /// </summary>
        /// <value>
        /// A <see cref="System.Drawing.Color"/> initialized from <see cref="Value"/>.
        /// </value>
        public Color Color
        {
            get => Color.FromArgb(Value);
        ...
        private Color24BppRgb(int value)
            : this(
                value >> (BitArray.BitsPerByte * RedIndex),
                value >> (BitArray.BitsPerByte * GreenIndex),
                value >> (BitArray.BitsPerByte * BlueIndex))
        {
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="Color24BppRgb"/> struct using the
        /// specified <see cref="System.Drawing.Color"/>.
        /// </summary>
        /// <param name="color">
        /// A <see cref="System.Drawing.Color"/> value.
        /// </param>
        ...
        /// <summary>
        /// Converts a <see cref="System.Drawing.Color"/> structure to a <see cref="Color24BppRgb"/>
        /// structure.
        /// </summary>
        /// <param name="color">
        /// The <see cref="System.Drawing.Color"/> to be converted.
        /// </param>
        /// <returns>
        /// The <see cref="Color24BppRgb"/> that results from the conversion.
        /// </returns>
        ...
        /// <summary>
        /// Converts a <see cref="Color24BppRgb"/> structure to a <see cref="System.Drawing.Color"/>
        /// structure.
        /// </summary>
        /// <param name="color24">
        /// The <see cref="Color24BppRgb"/> to be converted.
        /// </param>
        /// <returns>
        /// The <see cref="System.Drawing.Color"/> that results from the conversion.
        /// </returns>
